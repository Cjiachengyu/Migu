 ...
 * 提示*************************
 ******************************************************************************/
window.UMEDITOR_HOME_URL = "/migu/resources/thirdparty/umeditor/";
...
(function() {
	...
	window.UMEDITOR_CONFIG = {
		...
		/*
		 * ,toolbar:[ 'source | undo redo | bold italic underline strikethrough |
		 ...
		 * justifyjustify |', 'link unlink | emotion image video | map', '|
		 * horizontal print preview fullscreen', 'drafts', 'formula' ]
		 */
		,
		toolbar : [ 'source undo redo fontsize forecolor backcolor bold italic underline strikethrough'
			, '| justifyleft justifycenter justifyright'
			, '| superscript subscript formula image' ]
