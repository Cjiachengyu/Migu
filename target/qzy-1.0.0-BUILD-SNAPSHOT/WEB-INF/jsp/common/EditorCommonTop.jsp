...
<head>
    ...
    <link href="${resRoot}/image/qzy_logo.png" type="image/x-icon" rel="shortcut icon" />
        ...
        <div class="top_holder wrap relative">
            ...
            <div class="top_right_top_holder">
                <div class="top_left_info_small_info">
                    ...
                    <a href="/qzy/editor/setting/changepwd">[修改密码]</a>
                    <a href="/qzy/editor/home/logout">[退出]</a>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="top_right_holder">
	            ...
	            <c:if test="${sessionScope.admin != null}">
	            	<div class="top_main_menu_div">
                        <a class="top_main_menu" href="/qzy/editor/list/prizelist">奖品查看</a>

                        <div id="main_menu_prize_list" class="main_menu"></div>
                    </div>
                    <div class="top_main_menu_div">
                        <a class="top_main_menu" href="/qzy/editor/prizeedit/editprize">奖品录入</a>

                        <div id="main_menu_prize_edit" class="main_menu"></div>
                    </div>
                    <div class="top_main_menu_div">
                        <a class="top_main_menu" href="/qzy/editor/quelist/main">题库查看</a>

                        <div id="main_menu_que_list" class="main_menu"></div>
                    </div>
                    <div class="top_main_menu_div">
                        <a class="top_main_menu" href="/qzy/editor/queedit/create">题目录入</a>
