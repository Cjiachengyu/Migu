...
<div class="grab_bag_info_holder">
    ...
    <div class="operation_btn_holder">
        ...
        <a class="orange_2d_btn operation_btn" href="/qzy/user/createbag/gotoshuati?zsk=${viewModel.bag.zskId}&zsd1=${viewModel.bag.zsd1Id}&zsd2=${viewModel.bag.zsd2Id}&difficulty=0">继续刷题</a>
    </div>
</div>
