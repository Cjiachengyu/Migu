...
<div class="top_tab_holder">
    ...
    -->
    <a class="top_tab tab_selected"><img class="title_img" src="${resRoot}/image/user/rank/title_sent_money_selected.png">返币榜</a>
...
<div class="user_info_holder">
    ...
    <div class="left_info">
        <div>累计返还</div>
        <div class="color_red" >${viewModel.user.returnedMoney}币</div>
    </div>
    <div class="right_info">
        <div>排名</div>
        <div class="color_red">${viewModel.myReturnedMoneyRank}</div>
    </div>
</div>

<div class="list_holder">
	<c:forEach items="${viewModel.userReturnedMoneyRankList}" var="item" varStatus="status">
		<div class="list_item">
			...
			<div class="list_item_count"><span>${item.returnedMoney}币</span></div>
			<div class="clear"></div>
		</div>
	</c:forEach>
</div>
