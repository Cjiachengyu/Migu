function changStarStatus() {
	...
	if (starStatusValue == 2) {
		...
		window.location.href = "/migu/user/createbag/gotoshuati" + "?zsk=" + zskId + "&zsd1=" + zsd1Id + "&zsd2=" + zsd2Id + "&difficulty=0";
	}
...
function changMoonStatus() {
	...
	if (moonStatusValue == 2) {
		...
		window.location.href = "/migu/user/createbag/gotoshuati" + "?zsk=" + zskId + "&zsd1=" + zsd1Id + "&zsd2=0&difficulty=0";
	}
