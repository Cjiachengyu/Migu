...
<link href="${resRoot}/css/user/grabbag/enterNoChance.css?version=${resVersion}" rel="stylesheet"/>
...
<div class="grab_bag_info_holder">
    <img class="grab_bag_title_img" src="${resRoot}/image/user/grabbag/title_enter_no_chance.png?v=2">
    <img class="grab_bag_face_img" src="${resRoot}/image/user/grabbag/face_fail_no_chance.png">
